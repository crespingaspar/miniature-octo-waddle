<template>
	<div class="main-content" :style='{"padding":"30px"}'>
		<!-- 列表页 -->
		<div v-if="!showFlag">
			<el-form :style='{"border":"0px solid #ddd","padding":"30px 60px 30px 30px","boxShadow":"inset 0px -2px 6px 0px  #497afa60","borderRadius":"0 0 10px 10px","flexWrap":"wrap","background":"#ffffff","display":"flex"}' :inline="true" :model="searchForm" class="add-update-preview">
				<el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' label="试卷名称">
					<el-input v-model="searchForm.papername" placeholder="试卷名称" clearable></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' label="试题名称">
					<el-input v-model="searchForm.questionname" placeholder="试题名称" clearable></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}'>
