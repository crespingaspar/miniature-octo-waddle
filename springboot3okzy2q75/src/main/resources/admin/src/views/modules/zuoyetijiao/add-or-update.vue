	...
	<div class="addEdit-block">
		...
		>
			<template >
				...
				<el-form-item class="fileupload" v-if="type!='info'&& !ro.tijiaozuoye" label="提交作业" prop="tijiaozuoye" >
					<file-upload
						tip="点击上传提交作业"
						action="file/upload"
						:limit="1"
						:type="2"
						:multiple="true"
						:disabled="ro.tijiaozuoye"
						:fileUrls="ruleForm.tijiaozuoye?ruleForm.tijiaozuoye:''"
						@change="tijiaozuoyeUploadChange"
					></file-upload>
				</el-form-item>  
				<el-form-item v-else-if="ruleForm.tijiaozuoye" label="提交作业" prop="tijiaozuoye" >
					<el-button class="downBtn" type="text" size="small" @click="download($base.url+ruleForm.tijiaozuoye)">
