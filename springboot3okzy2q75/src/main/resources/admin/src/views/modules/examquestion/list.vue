		...
		<template v-if="!showFlag">
			<el-form :style='{"width":"100%","padding":"0","margin":"0 0 10px"}' :inline="true" :model="searchForm" class="center-form-pv">
				...
				<el-row class="actions" :style='{"width":"calc(100% + 8px)","margin":"0px 0 10px -4px","flexWrap":"wrap","display":"flex"}'>
					<el-button v-if="isAuth('examquestion','新增')" class="add" :style='{"border":"0","cursor":"pointer","padding":"0 0px","margin":"4px","outline":"none","color":"#4f7df5","borderRadius":"6px","background":"none","width":"auto","fontSize":"14px","height":"36px"}' type="success" @click="addOrUpdateHandler()">
						<span class="icon iconfont icon-tianjia16" :style='{"margin":"0 0px","fontSize":"16px","color":"#4f7df5","height":"auto"}'></span>
						添加
					</el-button>
					<el-button v-if="isAuth('examquestion','删除')" class="del" :disabled="dataListSelections.length <= 0" :style='{"border":"0","cursor":"pointer","padding":"0 0px","margin":"4px","outline":"none","color":"#f30","borderRadius":"6px","background":"none","width":"auto","fontSize":"14px","height":"36px"}' type="danger" @click="deleteHandler()">
			...
			<div :style='{"width":"100%","padding":"0","boxShadow":"none","borderRadius":"0"}'>
				...
				>
					...
					>
						<template slot-scope="scope">
							<el-button v-if="isAuth('examquestion','修改')" class="edit" :style='{"border":"0","cursor":"pointer","padding":"0 0px","margin":"0 5px 5px 0","outline":"none","color":"#38acde","borderRadius":"6px","background":"none","width":"auto","fontSize":"14px","height":"32px","order":"-1"}' type="success" @click="addOrUpdateHandler(scope.row.id)">
								<span class="icon iconfont icon-xiugai17" :style='{"margin":"0 0px","fontSize":"14px","color":"#38acde","height":"40px"}'></span>
								修改
							</el-button>
							<el-button v-if="isAuth('examquestion','删除')" class="del" :style='{"border":"0","cursor":"pointer","padding":"0 0px","margin":"0 5px 5px 0","outline":"none","color":"#e56060","borderRadius":"6px","background":"none","width":"auto","fontSize":"14px","height":"32px"}' type="primary" @click="deleteHandler(scope.row.id)">
