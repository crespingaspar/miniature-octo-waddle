<template>
	<div class="main-content" :style='{"padding":"30px"}'>
		...
		<template v-if="!showFlag">
			<el-form :style='{"width":"100%","padding":"0","margin":"0 0 10px"}' :inline="true" :model="searchForm" class="center-form-pv">
				<el-row :style='{"padding":"0px","boxShadow":"none","borderRadius":"10px","flexWrap":"wrap","display":"flex","width":"100%","position":"relative"}'>
					...
					<el-button class="search" :style='{"border":"0","cursor":"pointer","padding":"0 12px 0 10px","outline":"none","color":"#fff","borderRadius":"6px","background":"#497afa","width":"auto","fontSize":"16px","height":"36px"}' type="success" @click="search()">
				...
				<el-row class="actions" :style='{"width":"calc(100% + 8px)","margin":"0px 0 10px -4px","flexWrap":"wrap","display":"flex"}'>
					<el-button v-if="isAuth('examquestionbank','新增')" class="add" :style='{"border":"0","cursor":"pointer","padding":"0 0px","margin":"4px","outline":"none","color":"#4f7df5","borderRadius":"6px","background":"none","width":"auto","fontSize":"14px","height":"36px"}' type="success" @click="addOrUpdateHandler()">
						<span class="icon iconfont icon-tianjia16" :style='{"margin":"0 0px","fontSize":"16px","color":"#4f7df5","height":"auto"}'></span>
						添加
					</el-button>
					<el-button v-if="isAuth('examquestionbank','删除')" class="del" :disabled="dataListSelections.length <= 0" :style='{"border":"0","cursor":"pointer","padding":"0 0px","margin":"4px","outline":"none","color":"#f30","borderRadius":"6px","background":"none","width":"auto","fontSize":"14px","height":"36px"}' type="danger" @click="deleteHandler()">
					...
					<download-excel v-if="isAuth('examquestion','导出')" class = "export-excel-wrapper" :data = "dataList" :fields = "json_fields" name = "试卷题目.xls">
						...
						<el-button class="btn18" type="success">
							<span class="icon iconfont icon-xiazai7" :style='{"margin":"0 0px","fontSize":"16px","color":"#333","height":"auto"}'></span>
							导出
						</el-button>
					</download-excel>
					<el-button class="btn18" v-if="isAuth('examquestion','打印')"  type="success" @click="printJson">
						<span class="icon iconfont icon-dayin2" :style='{"margin":"0 0px","fontSize":"16px","color":"#333","height":"auto"}'></span>
						打印
					</el-button>
				</el-row>
			</el-form>
			...
			<div :style='{"width":"100%","padding":"0","boxShadow":"none","borderRadius":"0"}'>
				...
				>
					...
					>
						<template slot-scope="scope">
							<el-button v-if="isAuth('examquestionbank','修改')" class="edit" :style='{"border":"0","cursor":"pointer","padding":"0 0px","margin":"0 5px 5px 0","outline":"none","color":"#38acde","borderRadius":"6px","background":"none","width":"auto","fontSize":"14px","height":"32px","order":"-1"}' type="success" @click="addOrUpdateHandler(scope.row.id)">
								<span class="icon iconfont icon-xiugai17" :style='{"margin":"0 0px","fontSize":"14px","color":"#38acde","height":"40px"}'></span>
								修改
							</el-button>
							<el-button v-if="isAuth('examquestionbank','删除')" class="del" :style='{"border":"0","cursor":"pointer","padding":"0 0px","margin":"0 5px 5px 0","outline":"none","color":"#e56060","borderRadius":"6px","background":"none","width":"auto","fontSize":"14px","height":"32px"}' type="primary" @click="deleteHandler(scope.row.id)">
