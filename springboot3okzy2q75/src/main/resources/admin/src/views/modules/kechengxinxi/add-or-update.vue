	...
	<div class="addEdit-block">
		...
		>
			<template >
				...
				<el-form-item class="input" v-else-if="ruleForm.kechenghao" label="课程号" prop="kechenghao" >
					<el-input v-model="ruleForm.kechenghao" placeholder="课程号" readonly></el-input>
				</el-form-item>
				...
				<el-form-item class="select" v-if="type!='info'"  label="课程分类" prop="kechengfenlei" >
					<el-select :disabled="ro.kechengfenlei" v-model="ruleForm.kechengfenlei" placeholder="请选择课程分类"  filterable>
						<el-option
				...
				<el-form-item class="input" v-if="type!='info'"  label="课时" prop="keshi" >
					<el-input-number v-model="ruleForm.keshi" placeholder="课时" :disabled="ro.keshi"></el-input-number>
				</el-form-item>
			...
			<el-form-item v-if="type!='info'" class="editorBox" label="课程内容" prop="kechengneirong" >
				<editor 
					style="min-width: 200px; max-width: 600px;"
					v-model="ruleForm.kechengneirong" 
					class="editor"
					myQuillEditor="kechengneirong"
					action="file/upload">
				</editor>
			</el-form-item>
			<el-form-item v-else-if="ruleForm.kechengneirong" label="课程内容" prop="kechengneirong"  class="textBox">
				<span class="text ql-snow ql-editor" v-html="ruleForm.kechengneirong"></span>
			</el-form-item>
			...
			async info(id) {
				await this.$http({
					...
					if (data && data.code === 0) {
						...
						this.ruleForm.kechengneirong = this.ruleForm.kechengneirong.replace(reg,'../../../springboot3okzy2q75/upload');
					} else {
						this.$message.error(data.msg);
					}
				});
