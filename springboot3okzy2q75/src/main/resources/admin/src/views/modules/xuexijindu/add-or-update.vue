	...
	<div class="addEdit-block">
		...
		>
			<template >
				...
				<el-form-item class="input" v-if="type!='info'"  label="作业完成率" prop="zuoyewanchenglv" >
					<el-input-number v-model="ruleForm.zuoyewanchenglv" placeholder="作业完成率" :disabled="ro.zuoyewanchenglv"></el-input-number>
				</el-form-item>
				<el-form-item v-else class="input" label="作业完成率" prop="zuoyewanchenglv" >
					<el-input v-model="ruleForm.zuoyewanchenglv" placeholder="作业完成率" readonly></el-input>
				</el-form-item>
				...
				<el-form-item class="date" v-if="type!='info'" label="学习时间" prop="xuexishijian" >
					<el-date-picker
						...
						:picker-options="xuexishijianPickerOptions"
						placeholder="学习时间"
					></el-date-picker>
				</el-form-item>
			...
			<el-form-item class="textarea" v-if="type!='info'" label="知识掌握情况" prop="zhishizhangwoqingkuang" >
				<el-input
					style="min-width: 200px; max-width: 600px;"
					type="textarea"
					:rows="8"
					placeholder="知识掌握情况"
					v-model="ruleForm.zhishizhangwoqingkuang" >
				</el-input>
			</el-form-item>
			<el-form-item v-else-if="ruleForm.zhishizhangwoqingkuang" label="知识掌握情况" prop="zhishizhangwoqingkuang"  class="textBox">
				<span class="text">{{ruleForm.zhishizhangwoqingkuang}}</span>
			</el-form-item>
		...
		data() {
			...
			return {
				...
				ro:{
					...
					tupian : false,
					nandu : false,
					zuoyewanchenglv : false,
					zhishizhangwoqingkuang : false,
					xuehao : false,
					xingming : false,
					gonghao : false,
				...
				rules: {
					...
					zuoyewanchenglv: [
						{ required: true, message: '作业完成率不能为空', trigger: 'blur' },
						{ validator: validateNumber, trigger: 'blur' },
					],
					zhishizhangwoqingkuang: [
						{ required: true, message: '知识掌握情况不能为空', trigger: 'blur' },
					],
					xuehao: [
					],
					xingming: [
			...
			init(id,type ) {
				...
				if(this.type=='info'||this.type=='else'||this.type=='msg'){
					...
					for (var o in obj){
						...
						if(o=='zuoyewanchenglv'){
							this.ruleForm.zuoyewanchenglv = obj[o];
							this.ro.zuoyewanchenglv = true;
							continue;
						}
						if(o=='zhishizhangwoqingkuang'){
							this.ruleForm.zhishizhangwoqingkuang = obj[o];
							this.ro.zhishizhangwoqingkuang = true;
							continue;
						}
						if(o=='xuehao'){
			...
			async onSubmit() {
					...
					await this.$refs["ruleForm"].validate(async valid => {
						if (valid) {
							...
							let errMsg = ''
							if(this.type=='cross') {
								await this.$http.post('updateColumn/xuankexinxi/2',{
									csuUpdateColumn: 'keshi',
									csuUpdateColumnValue: '-1',
									csuConditionColumn: 'kechenghao',
									csuConditionColumnValue: this.ruleForm.kechenghao
								}).then(rs=>{
									if(rs.data.code!=0) {
										changeType = false
										errMsg = '已完成学习'
