	...
	<div class="addEdit-block">
		...
		>
			<template >
				...
				<el-form-item class="fileupload" v-if="type!='info'&& !ro.zizhizhengming" label="资质证明" prop="zizhizhengming" >
					<file-upload
						tip="点击上传资质证明"
						action="file/upload"
						:limit="1"
						:type="2"
						:multiple="true"
						:disabled="ro.zizhizhengming"
						:fileUrls="ruleForm.zizhizhengming?ruleForm.zizhizhengming:''"
						@change="zizhizhengmingUploadChange"
					></file-upload>
				</el-form-item>  
				<el-form-item v-else-if="ruleForm.zizhizhengming" label="资质证明" prop="zizhizhengming" >
					<el-button class="downBtn" type="text" size="small" @click="download($base.url+ruleForm.zizhizhengming)">
				...
				<el-form-item class="input" v-if="type!='info'"  label="擅长科目" prop="shanzhangkemu" >
					<el-input v-model="ruleForm.shanzhangkemu" placeholder="擅长科目" clearable  :readonly="ro.shanzhangkemu"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="擅长科目" prop="shanzhangkemu" >
					<el-input v-model="ruleForm.shanzhangkemu" placeholder="擅长科目" readonly></el-input>
				</el-form-item>
				<el-form-item class="input" v-if="type!='info'"  label="教学风格" prop="jiaoxuefengge" >
					<el-input v-model="ruleForm.jiaoxuefengge" placeholder="教学风格" clearable  :readonly="ro.jiaoxuefengge"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="教学风格" prop="jiaoxuefengge" >
					<el-input v-model="ruleForm.jiaoxuefengge" placeholder="教学风格" readonly></el-input>
				</el-form-item>
			...
			<el-form-item v-if="type!='info'" class="editorBox" label="辅导成果" prop="fudaochengguo" >
				<editor 
			...
			<el-form-item v-else-if="ruleForm.fudaochengguo" label="辅导成果" prop="fudaochengguo"  class="textBox">
				<span class="text ql-snow ql-editor" v-html="ruleForm.fudaochengguo"></span>
			</el-form-item>
			...
			init(id,type ) {
				...
				if(this.type=='info'||this.type=='else'||this.type=='msg'){
					...
					for (var o in obj){
						...
						if(o=='shanzhangkemu'){
							this.ruleForm.shanzhangkemu = obj[o];
							this.ro.shanzhangkemu = true;
							continue;
						}
						if(o=='jiaoxuefengge'){
							this.ruleForm.jiaoxuefengge = obj[o];
							this.ro.jiaoxuefengge = true;
							continue;
						}
						if(o=='fudaochengguo'){
							this.ruleForm.fudaochengguo = obj[o];
							this.ro.fudaochengguo = true;
							continue;
						}
						if(o=='mobile'){
			...
			async info(id) {
				await this.$http({
					...
					if (data && data.code === 0) {
						...
						this.ruleForm.fudaochengguo = this.ruleForm.fudaochengguo.replace(reg,'../../../springboot3okzy2q75/upload');
					} else {
						this.$message.error(data.msg);
					}
				});
