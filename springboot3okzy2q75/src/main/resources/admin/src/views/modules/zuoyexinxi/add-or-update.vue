	...
	<div class="addEdit-block">
		...
		>
			<template >
				...
				<el-form-item class="fileupload" v-if="type!='info'&& !ro.zuoyewenjian" label="作业文件" prop="zuoyewenjian" >
					<file-upload
						tip="点击上传作业文件"
						action="file/upload"
						:limit="1"
						:type="2"
						:multiple="true"
						:disabled="ro.zuoyewenjian"
						:fileUrls="ruleForm.zuoyewenjian?ruleForm.zuoyewenjian:''"
						@change="zuoyewenjianUploadChange"
					></file-upload>
				</el-form-item>  
				<el-form-item v-else-if="ruleForm.zuoyewenjian" label="作业文件" prop="zuoyewenjian" >
					<el-button class="downBtn" type="text" size="small" @click="download($base.url+ruleForm.zuoyewenjian)">
			...
			<el-form-item v-else-if="ruleForm.zuoyeyaoqiu" label="作业要求" prop="zuoyeyaoqiu"  class="textBox">
