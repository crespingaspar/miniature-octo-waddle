...
<template>
	<div class="addEdit-block">
		...
		>
			<template >
				<el-form-item class="input" v-if="type!='info'"  label="节数" prop="sectionnum" >
					<el-input v-model.number="ruleForm.sectionnum" placeholder="节数" clearable  :readonly="ro.sectionnum"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="节数" prop="sectionnum" >
					<el-input v-model="ruleForm.sectionnum" placeholder="节数" readonly></el-input>
				</el-form-item>
				<el-form-item class="input" v-if="type!='info'" label="开始时间" prop="starttime" >
					<el-time-select
				...
				<el-form-item class="input" v-else-if="ruleForm.starttime" label="开始时间" prop="starttime" >
					<el-input v-model="ruleForm.starttime" placeholder="开始时间" readonly></el-input>
				</el-form-item>
				<el-form-item class="input" v-if="type!='info'" label="结束时间" prop="endtime" >
					<el-time-select
				...
				<el-form-item class="input" v-else-if="ruleForm.endtime" label="结束时间" prop="endtime" >
					<el-input v-model="ruleForm.endtime" placeholder="结束时间" readonly></el-input>
				</el-form-item>
			</template>
			...
			async onSubmit() {
					...
					await this.$refs["ruleForm"].validate(async valid => {
						if (valid) {
							...
							await this.$http({
								url: `scheduletime/${!this.ruleForm.id ? "save" : "update"}`,
								method: "post",
								data: this.ruleForm
							}).then(async ({ data }) => {
								if (data && data.code === 0) {
									this.$message({
										...
										onClose: () => {
											...
											this.parent.scheduletimeCrossAddOrUpdateFlag = false;
											this.parent.search();
										}
									});
								} else {
