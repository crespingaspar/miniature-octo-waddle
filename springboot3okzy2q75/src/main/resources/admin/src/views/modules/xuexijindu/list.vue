...
<template>
	<div class="main-content" :style='{"padding":"30px"}'>
		...
		<template v-if="showFlag ">
			...
			<div :style='{"width":"100%","padding":"0","boxShadow":"none","borderRadius":"0"}'>
				<el-table class="tables"
					...
					<el-table-column :resizable='true' :sortable='true'
												prop="zuoyewanchenglv"
						label="作业完成率">
						<template slot-scope="scope">
							{{scope.row.zuoyewanchenglv}}
						</template>
					</el-table-column>
					<el-table-column :resizable='true' :sortable='true'
												prop="xuehao"
					...
					<el-table-column width="300" label="操作">
						<template slot-scope="scope">
							...
							<el-button class="btn8" v-if="isAuth('xuexijindu','课后辅导')" @click="kehoufudaoCrossAddOrUpdateHandler(scope.row,'cross','','','','')" type="success">
		...
		<kehoufudao-cross-add-or-update v-if="kehoufudaoCrossAddOrUpdateFlag" :parent="this" ref="kehoufudaoCrossaddOrUpdate"></kehoufudao-cross-add-or-update>
...
<script>
	...
	import kehoufudaoCrossAddOrUpdate from "../kehoufudao/add-or-update";
	import {
		Loading
	} from 'element-ui';
	export default {
		data() {
			return {
				...
				kehoufudaoCrossAddOrUpdateFlag: false,
		...
		methods: {
			...
			kehoufudaoCrossAddOrUpdateHandler(row,type,crossOptAudit,crossOptPay,statusColumnName,tips,statusColumnValue){
				this.showFlag = false;
				this.addOrUpdateFlag = false;
				this.kehoufudaoCrossAddOrUpdateFlag = true;
				this.$storage.set('crossObj',row);
				this.$storage.set('crossTable','xuexijindu');
				...
				if(statusColumnName!=''&&!statusColumnName.startsWith("[")) {
					...
					for (var o in obj){
						if(o==statusColumnName && obj[o]==statusColumnValue){
							...
							this.showFlag = true;
							this.kehoufudaoCrossAddOrUpdateFlag = false;
							return;
						}
					}
				}
				this.$nextTick(() => {
					this.$refs.kehoufudaoCrossaddOrUpdate.init(row.id,type);
				});
			},
			init () {
			},
