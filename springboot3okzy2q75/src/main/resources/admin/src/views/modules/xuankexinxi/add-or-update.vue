	...
	<div class="addEdit-block">
		...
		>
			<template >
				...
				<el-form-item class="input" v-if="type!='info'"  label="剩余课时" prop="keshi" >
					<el-input-number v-model="ruleForm.keshi" placeholder="剩余课时" :disabled="ro.keshi"></el-input-number>
				</el-form-item>
				<el-form-item v-else class="input" label="剩余课时" prop="keshi" >
					<el-input v-model="ruleForm.keshi" placeholder="剩余课时" readonly></el-input>
				</el-form-item>
