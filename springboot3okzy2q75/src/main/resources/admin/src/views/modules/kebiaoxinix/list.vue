			...
			<el-form class="center-form-pv" :style='{"width":"100%","padding":"0","margin":"0 0 10px"}' :inline="true" :model="searchForm">
				...
				<el-row class="actions" :style='{"width":"calc(100% + 8px)","margin":"0px 0 10px -4px","flexWrap":"wrap","display":"flex"}'>
					...
					<el-button class="btn18" v-if="isAuth('kebiaoxinix','课程表')" type="success" @click="timeableClick()">
						<span class="icon iconfont icon-shuju17" :style='{"margin":"0 0px","fontSize":"16px","color":"#333","height":"auto"}'></span>
						课程表					</el-button>
				</el-row>
			</el-form>
			<div :style='{"width":"100%","padding":"0","boxShadow":"none","borderRadius":"0"}'>
				<el-table class="tables"
					...
					<el-table-column width="300" label="操作">
						<template slot-scope="scope">
							<el-button class="view" v-if=" isAuth('kebiaoxinix','查看')" type="success" @click="addOrUpdateHandler(scope.row.id,'info')">
			...
			async timeableClick() {
				...
				for (let x in this.dataList) {
					...
					let name =
						...
						+ '<br>' + this.dataList[x].banji
						+ '<br>' + this.dataList[x].jiaoshi
					arr.push({
