...
public class JiaoshiVO  implements Serializable {
	...
	public void setShanzhangkemu(String shanzhangkemu) {
		this.shanzhangkemu = shanzhangkemu;
	}
	
	/**
	 * 获取：擅长科目
	 */
	public String getShanzhangkemu() {
		return shanzhangkemu;
	}
	...
	public void setJiaoxuefengge(String jiaoxuefengge) {
		this.jiaoxuefengge = jiaoxuefengge;
	}
	
	/**
	 * 获取：教学风格
	 */
	public String getJiaoxuefengge() {
		return jiaoxuefengge;
	}
	...
	public void setFudaochengguo(String fudaochengguo) {
		this.fudaochengguo = fudaochengguo;
	}
	
	/**
	 * 获取：辅导成果
	 */
	public String getFudaochengguo() {
		return fudaochengguo;
	}
